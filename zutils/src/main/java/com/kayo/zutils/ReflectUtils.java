...
public class ReflectUtils {
     ...
     * @throws RException if reflect unsuccessfully
     */
     ...
     * @throws RException if reflect unsuccessfully
     */
    public ReflectUtils method(final String name) throws RException {
     ...
     * @throws RException if reflect unsuccessfully
     */
    public ReflectUtils method(final String name, final Object... args) throws RException {
        Class<?>[] types = getArgsType(args);
        try {
    ...
    public static class RException extends RuntimeException {
        ...
        private static final long serialVersionUID = 6687740753456744016L;
